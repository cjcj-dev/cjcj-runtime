...
static_assert(sizeof(std::mutex) == 8, "PagePool requires the Win64 libc++ 8-byte std::mutex ABI");
static_assert(alignof(std::mutex) == 8, "PagePool requires the Win64 libc++ std::mutex alignment");
