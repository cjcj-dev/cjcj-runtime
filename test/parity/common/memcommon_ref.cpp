...
int main()
{
    ...
    const size_t aligns[] = {8, 4096, 262144};
    for (size_t align : aligns) {
        std::printf("BATCH %zu %zu %zu\n", align, MapleRuntime::SizeManager::LimitSize(align),
            MapleRuntime::SizeManager::CalculatePageNum(align));
    }
