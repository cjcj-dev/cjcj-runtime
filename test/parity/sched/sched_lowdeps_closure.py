...
# Cangjie constructor symbols contain literal angle brackets. GNU objdump
# truncates a resolved self-target at the first '>', so retain the stricter
# relocation-backed parser already used by the Processor foundation gate.
