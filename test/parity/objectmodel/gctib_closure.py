...
try:
    ...
    print(f'GCTIB_NOHEAP_CLOSURE reachable_defs={len(reached)} scanned_pre={len(reached)} scanned_final={len(reached)} scanned_object={len(reached)} native_defs=0 missing=0 status=PASS')
